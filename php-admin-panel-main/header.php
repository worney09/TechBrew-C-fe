...
$menuItems = [
    ...
    [
        ...
        "pages" => [
            ["title" => "Registration", "url" => "registration.php"]
        ],
    ],
];
...
<div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <!-- ✅ Added Register New User link just above Logout -->
                    <li class="nav-item">
                        <a href="registration.php" class="nav-link <?= $currentPage === 'registration.php' ? 'active' : '' ?>">
    ...
    <!-- Content wrapper starts here for pages to continue -->
